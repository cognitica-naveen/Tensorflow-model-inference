...
class ObjectDetectionProcessor:
    def __init__(self, model_dir, labels_path, min_conf_thresh=0.4):
    ...
    def process_half_frame(self, image_np):
            ...
            for i in range(num_detections):
                ...
                if (score >= .3 and self.category_index[class_id]["name"] in ['Hardhat','Helmet','Safety Vest','Vest']) or (self.category_index[class_id]["name"]=='Goggle' and score >= .45):
    ...
    def process_bottom_half_frame(self, image_np):
            ...
            for i in range(num_detections):
                ...
                # if score >= self.MIN_CONF_THRESH and self.category_index[class_id]["name"] != 'Person' and self.category_index[class_id]["name"] != 'Vest':
                if score >= .4 and self.category_index[class_id]["name"] == 'Shoe':
...
if __name__ == "__main__":
    ...
    output_video_path = 'v3_output.mp4'
    ...
    processor.process_video( output_video_path,VIDEO_PATH)
